...
On the [previous release](/news/2014/01/29/release), we announced that we'll release the version 1.0 today. However, now the version 0.9.9 is released. Why not 1.0?
