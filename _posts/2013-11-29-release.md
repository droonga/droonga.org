...
The current Droonga version is 1.0.0. It means "usable" not "stable". The current Droonga provides basic core features but many other features aren't implemented yet. Error handlings are also not perfect yet.
 ...
 * Droonga 1.0.0 is usable but not stable.
 * If you're brave, try Droonga 1.0.0!
